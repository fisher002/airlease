    ...
    <div class="detail-body">
      ...
      <div class="detail-body-right">
        <div class="body-right-message">
          <div>{{datas.detaildata.name}}</div>
          <div>{{datas.detaildata.introduce}}</div>
          <div>{{datas.detaildata.moneymsg}}</div>
          <div>{{datas.detaildata.tips}}</div>
          <div>{{datas.detaildata.praise}}</div>
        </div>
