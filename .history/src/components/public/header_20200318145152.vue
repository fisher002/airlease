  ...
  <div class="header_box">
    <div class="header_head">
      ...
      <div class="header_head_right">
        <div  v-if="userdata != null" class="header_head_right_box">
          <img width="50" height="50" src="../../../static/img/zhou.jpg" />
          <div class="box_msg">
            <el-dropdown trigger="click">
              <span class="el-dropdown-link font-size">暂未登录,点击登录</span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click="toLogin()">立即登录</el-dropdown-item>
                <el-dropdown-item>没账号?立即注册</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </div>
        </div>
        <div v-else class="header_head_right_box">
          <img width="50" height="50" src="../../../static/img/zhou.jpg" />
          <div class="box_msg">
            <el-dropdown trigger="hover">
              <span class="el-dropdown-link font-size">xxx，欢迎您</span>
              <el-dropdown-menu slot="dropdown">
