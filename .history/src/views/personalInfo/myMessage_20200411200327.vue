<template>
  <div class="box">
    <div class="box-head">
      <div class="head-left">
        <div class="head-left-img" v-if="userData">
          <img height="100" width="100" :src="userData.headPicture" />
        </div>
    ...
    <el-dialog title="密码修改" :visible.sync="dialogFormVisible" width="500px" center>
      <el-form :model="editPassword" :rules="passRule" ref="checkPassFor">
        <el-form-item label="原密码" prop="oldPassword">
          <el-input type="password" v-model="editPassword.oldPassword" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="新密码" prop="newPassword">
          <el-input type="password" v-model="editPassword.newPassword" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="确认新密码" prop="confirmPassword">
          <el-input type="password" v-model="editPassword.confirmPassword" auto-complete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="submitPassForm('checkPassFor')">确认修改</el-button>
        <el-button type="primary" @click="resetPassForm('checkPassFor')">重 置</el-button>
      </div>
    </el-dialog>
  </div>
</template>
