<template>
  <div class="table-box">
    ...
    >
      ...
      <el-table-column prop="leaseStartDate" align="center" sortable label="开始日期" width="180">
        <template slot-scope="scope">
          <span style="margin-left: 10px">{{ formatDate(scope.row.leaseStartDate) }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="leaseEndDate" align="center" sortable label="结束日期" width="180">
        <template slot-scope="scope">
          <span style="margin-left: 10px">{{ formatDate(scope.row.leaseEndDate) }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="leasePriceSum" align="center" sortable label="总价格" width="90"></el-table-column>
      <el-table-column prop="username" align="center" sortable label="姓名" width="90"></el-table-column>
