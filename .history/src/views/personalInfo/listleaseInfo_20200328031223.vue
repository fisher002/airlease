<template>
  <div class="table-box">
    ...
    >
      ...
      <el-table-column prop="leaseEndtDate" align="center" sortable label="结束日期" width="180"></el-table-column>
      <el-table-column prop="leasePriceSum" align="center" sortable label="总价格" width="80"></el-table-column>
      <el-table-column prop="username" align="center" sortable label="姓名" width="180"></el-table-column>
