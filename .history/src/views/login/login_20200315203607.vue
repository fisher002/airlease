<template>
  <div class="box">
      ...
      <el-col :span="6" :offset="9">
        <div class="grid-content second_box">
          <div class="second_choose">
            <div class="input_width choose_left choose_color" @click.stop="isShowLoginType == true">普通用户登录</div>
            <div class="input_width choose_right choose_color" @click.stop="isShowLoginType == false">管理员登陆</div>
          </div>
        </div>
      </el-col>
    </el-row>
    <div v-show="isShowLoginType">
    <el-row :gutter="20">
      <el-col :span="6" :offset="9">
    ...
    <div v-show="isShowLoginType == false"></div>
    <!-- <talk></talk> -->
  </div>
</template>
<script>
