  ...
  <div class="box">
    ...
    <el-row :gutter="20">
      <el-col :span="6" :offset="9">
        ...
        <div><span class="to_register" @click="showRegister = !showRegister">没有账号?立即注册</span></div>
      </el-col>
    </el-row>
    <!-- <talk></talk> -->
    <!-- <register></register> -->
    <el-dialog title="用户注册" :visible.sync="showRegister" width="30%">
      <register></register>
      <span slot="footer" class="dialog-footer">
        <el-button @click="showRegister = false">取 消</el-button>
        <el-button type="primary" @click="showRegister = false">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
