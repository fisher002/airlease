    ...
    <div v-if="showType == false">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="username" align="center" sortable label="租赁人姓名" width="100"></el-table-column>
          <el-table-column prop="leaseStartDate" align="center" sortable label="租赁开始时间" width="150"></el-table-column>
          <el-table-column prop="leaseEndDate" align="center" sortable label="租赁结束时间" width="150"></el-table-column>
          <el-table-column prop="leaseNumber" align="center" sortable label="租赁空调台数" width="100"></el-table-column>
          <el-table-column prop="leasePriceSum" align="center" sortable label="总价格" width="100"></el-table-column>
          <el-table-column prop="leaseEditDate" align="center" sortable label="操作时间" width="150"></el-table-column>
