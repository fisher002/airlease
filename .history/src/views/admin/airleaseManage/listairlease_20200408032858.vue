    ...
    <div v-if="showType == false">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="leaseStartDate" align="center" sortable label="租赁开始时间" width="200"></el-table-column>
          <el-table-column prop="leaseEndDate" align="center" sortable label="租赁结束时间" width="200"></el-table-column>
          ...
          <el-table-column prop="leaseEditDate" align="center" sortable label="操作时间" width="200"></el-table-column>
