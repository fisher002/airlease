    ...
    <div class="form-box" v-if="params.type == 'add'">
      ...
      >
        <el-form-item label="管理员名" prop="username">
          <el-input v-model="data.adminUserName" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input type="password" v-model="data.adminPassWord" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="确认密码" prop="confirmPassword">
          <el-input type="password" v-model="data.confirmPassword" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="昵称" prop="name">
          <el-input v-model="data.adminName" class="input-width"></el-input>
        </el-form-item>
        <el-form-item label="联系方式" prop="tellphone">
          <el-input v-model="data.adminTellPhone" class="input-width"></el-input>
        </el-form-item>
