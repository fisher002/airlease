  ...
  <div class="table-box">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="adminUserName" align="center" sortable label="用户名" width="300"></el-table-column>
        <el-table-column prop="adminName" align="center" sortable label="用户昵称" width="200"></el-table-column>
        <el-table-column prop="adminTellPhone" align="center" sortable label="电话号码" width="200"></el-table-column>
        <el-table-column prop="adminRegisterTime" align="center" sortable label="注册时间" width="200">
        ...
        <el-table-column prop="adminStatus" align="center" sortable label="用户状态" width="150">
          <template slot-scope="scope">
            <span
