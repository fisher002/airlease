  ...
  <div class="table-box">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="adminUserName" align="center" sortable label="用户名" width="200"></el-table-column>
        <el-table-column prop="adminName" align="center" sortable label="用户昵称" width="250"></el-table-column>
