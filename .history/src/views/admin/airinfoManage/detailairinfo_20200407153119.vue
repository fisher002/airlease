    ...
    <div class="form-box" v-if="params.type == 'add'">
      ...
      >
        ...
        <el-form-item label="空调描述" prop="airDescribe">
          <el-input v-model="data.airDescribe" class="input-width" clearable></el-input>
        </el-form-item>
    ...
    <div class="form-box" v-if="params.type == 'detail'">
      ...
      >
        ...
        <el-form-item label="空调描述" prop="airDescribe">
          ...
          <el-input v-else v-model="data.airDescribe" class="input-width" clearable></el-input>
        </el-form-item>
        <el-form-item label="空调租金" prop="airRent">
        ...
        <el-form-item label="入库时间" prop="airPutDate">
          <span v-if="isShowEdit == false">{{data.airPutDate}}</span>
