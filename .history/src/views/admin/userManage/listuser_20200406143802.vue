  ...
  <div class="table-box">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="username" align="center" sortable label="用户名" width="200"></el-table-column>
        ...
        <el-table-column prop="age" align="center" sortable label="年龄" width="100"></el-table-column>
        <el-table-column prop="sex" align="center" sortable label="性别" width="100">
