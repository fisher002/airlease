  ...
  <div class="table-box">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="username" align="center" sortable label="用户名" width="150"></el-table-column>
        <el-table-column prop="name" align="center" sortable label="用户昵称" width="250"></el-table-column>
        ...
        <el-table-column prop="邮箱" align="center" sortable label="email" width="150"></el-table-column>
        ...
        <el-table-column prop="地址" align="center" sortable label="address" width="200"></el-table-column>
