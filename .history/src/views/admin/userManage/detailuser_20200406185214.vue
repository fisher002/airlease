    ...
    <div class="form-box" v-if="params.type == 'add'">
      ...
      >
        ...
        <el-form-item label="QQ" prop="qq">
          <el-input v-model.number="data.qq" class="input-width" clearable></el-input>
        </el-form-item>
    ...
    <div class="form-box" v-if="params.type == 'detail'">
      ...
      >
        ...
        <el-form-item label="年龄" prop="age">
          ...
          <el-input v-else v-model.number="data.age" class="input-width" clearable></el-input>
        </el-form-item>
        <el-form-item v-show="isShowEdit" label="性别" prop="sex">
          <el-select style="float:left" v-model="data.sex" placeholder="请选择性别">
            <el-option label="男生" value="M"></el-option>
            <el-option label="女生" value="F"></el-option>
          </el-select>
        ...
        <el-form-item label="注册时间">
          <span v-if="isShowEdit == false">{{data.userRegisterTime}}</span>
