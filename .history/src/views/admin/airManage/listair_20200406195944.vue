    ...
    <div v-if="showType == false">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="airName" align="center" sortable label="空调名" width="200"></el-table-column>
          <el-table-column prop="airType" align="center" sortable label="空调类型" width="250"></el-table-column>
          <el-table-column prop="airModel" align="center" sortable label="空调型号"></el-table-column>
          <el-table-column prop="airPicture" align="center" sortable label="空调图片" width="200"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getAirList() {
      this.loading = true;
      api.getAirList(this.params).then(
        res => {
