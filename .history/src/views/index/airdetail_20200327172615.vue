    ...
    <el-dialog title="空调租赁" :visible.sync="dialogShow" width="500px" center>
      <el-form :model="leaseData" :rules="rules" ref="checkFor">
        ...
        <el-form-item label="租赁数量：">
          <el-input-number v-model.number="leaseData.leaseNumber" @change="calculationSum" :min="0" :max="1000" label="描述文字"></el-input-number>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      // 重置表单
      this.leaseData.startDate = '';
      this.leaseData.endDate = ''
    }
  }
};
</script>
