    ...
    <div v-if="showType == false">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="airDescribe" align="center" sortable label="空调描述"></el-table-column>
          ...
          <el-table-column prop="airStock" align="center" sortable label="库存" width="100"></el-table-column>
