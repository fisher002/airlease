    ...
    <div v-if="showType == false">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="commentContent" align="center" sortable label="评论内容"></el-table-column>
          <el-table-column prop="commentDate" align="center" sortable label="评论时间" width="300">
