<template>
  <div>
    ...
    <div class="grid-content">
      <el-button class="login_btn" type="primary" size="medium" @click="toLogin()">登录</el-button>
    </div>
    <div>
      <span class="to_register" @click="toRegister">没有账号?立即注册</span>
    </div>
  </div>
</template>
<script>
